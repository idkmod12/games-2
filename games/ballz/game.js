...
function gameOver() {
    ...
    if (window.ccPorted.user) {
        window.ccPorted.leaderboard.addScore(score);
    } else {
...
window.addEventListener("load", (e) => {
    window.ccPorted.leaderboard = new window.ccPorted.Leaderboard('ballz');
    ...
    window.ccPorted.leaderboard.loadScores(true).then(data => {
        ...
        data.forEach((entry, i) => {
            ...
            userSpan.textContent = (entry.rank) + ". " + displayName + "";
